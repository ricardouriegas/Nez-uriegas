...
if($_GET) {
	...
	stats($argv[1], $argv[2], $argv[3], $argv[4],$argv[5], $argv[6],$argv[7], $argv[8], $argv[9], $argv[10], $argv[11], $argv[12], $argv[13], $argv[14], $argv[15], $argv[16] );
}
 ...
 */
//function stats($tokenuser,$sizefile, $chunks, $sync, $beg, $sym, $signature, $cpabe, $packer, $total, $crypt, $ida_time, $raid_time, $up$
function stats($get){
//echo json_encode($get);
//print_r(array_keys($get));
