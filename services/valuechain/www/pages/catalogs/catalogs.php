...
if (isset($_GET["catalog"])) {
    ...
    $url = APIGATEWAY_HOST . '/pub_sub/v1/view/childs/catalog/' . $catalog . '?access_token=' . $_SESSION['access_token'];
    $response = $curl->get($url);
    if ($response["code"] == 200) {
    ...
    $catalogs = array();
    if ($response_sus["code"] == 200 && isset($response_sus["data"]["data"])) {
        $catalogs = $response_sus["data"]["data"];
    }
}
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Catalogs</strong> </h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
            ...
            <div class="content">
                ...
                <div class="row">
                    <div class="col-sm-1">
                        <a type="button" class="btn btn-outline-primary btn-block" href="catalogs.php?father=<?php echo $granpa; ?>"><i class="fa fa-arrow-left"></i> Back</a>
                    </div>
                    <div class="col-sm-9">
                ...
                <table id="executionsTable" class="table table-bordered table-striped">
                    ...
                    <tbody id="tblexecutionsBody">
                        <?php foreach ($catalogs as $c) : ?>
                            ...
                            <tr>
                                <td><a href="catalogs.php?catalog=<?php echo $c["tokencatalog"] ?>"><?php echo $c["namecatalog"]; ?></a></td>
